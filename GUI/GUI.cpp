...
operationType GUI::GetUseroperation() const
{
	...
	if (y >= 0 && y < ToolBarHeight)
	{
		...
		case ICON_SQU: return DRAW_SQU;// Add this line
...
void GUI::CreateDrawToolBar()
{
	...
	//reorder them in UI_Info.h ==> enum DrawMenuIcon
	string MenuIconImages[DRAW_ICON_COUNT];
	MenuIconImages[ICON_RECT] = "images\\MenuIcons\\Menu_Rect.jpg";
	MenuIconImages[ICON_TRI] = "images\\MenuIcons\\Menu_Tri.jpg";
	MenuIconImages[ICON_SQU] = "images\\MenuIcons\\Menu_Squ.jpg"; // Add this line
...
void GUI::DrawSquare(Point P1, int length, GfxInfo SquareGfxInfo) const
{
	color DrawingClr;
